...
BOTSORT_TRACK_BUFFER      = int  (os.getenv("BOTSORT_TRACK_BUFFER",      "100"))  # bajado de 200: ablation 2026-07-03 (ver docs/PLAN_player_tracking.md, T8) no mostró diferencia medible 100 vs 150 vs 200 en dos clips reales (incl. un córner), y 200 supera el umbral de riesgo de "deriva fantasma" que señala el research externo.
